...
- `spinner-words.md` — Official catalog of all `149` spinner words with status tracking, Chinese translations, and descriptions
...
- Known longer animations:
  ...
  - `Tinkering` — `8` frames
  - `Thundering` — `8` frames
- The generator currently covers `149` official spinner words
